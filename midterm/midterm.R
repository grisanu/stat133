...
m = matrix(seq(10,120,10), nrow = 3, ncol = 4, byrow = T);
...
n = data.frame("num" = 1:10, "lett" = letters[1:10], "even" = c(F,T));
...
nmat = matrix(rnorm(100*100, mean = 6, sd = 2), nrow = 100, ncol = 100); ##
...
in_year_2000 = which(day[[1]] >= 2000 & day[[1]] < 2001) ##

plot(day[[1]][in_year_2000], rain[[1]][in_year_2000],
     ylab = "Precipitation",
     xlab = "Day")
